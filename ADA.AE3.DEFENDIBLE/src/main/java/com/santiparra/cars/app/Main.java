...
public class Main {
	...
	public static void addPerson() throws DatabaseException {
		...
		try {
			do {
				...
				Person person = new Person(id, address, name);
	...
	public static void exampleData() {
		...
		try {
			...
			// Crear personas
			Person person1 = new Person("PersonA", "Sergio Alejo", "c/Pez 1ºA");
			Person person2 = new Person("PersonB", "Elia Bastian", "c/Pez 1ºB");
			Person person3 = new Person("PersonC", "Juan Clase", "c/Pez 1ºC");
